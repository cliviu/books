 ...
 * and open the template in the editor.f.table
 */
package gbooks;
...
public class BooksFinder {
  ...
  public static Volumes queryGoogleBooksByIsbn(String isbn) throws Exception {
      return queryGoogleBooks("isbn:" + isbn);
  }     
  
  public static Volumes queryGoogleBooks(String query) throws Exception {
    ...
    final Books books = new Books.Builder(new NetHttpTransport(), jsonFactory, null)
      ...
      /* OLD way
      JsonHttpRequestInitializer credential = new GoogleKeyInitializer("AIzaSyBvn8NIZ_g3me6tBichcI9bJ7GDpy3u8ec");
    // Set up Books client.
    final Books books = new Books.Builder(new NetHttpTransport(), jsonFactory, null)
        .setApplicationName("Google-BooksSample/1.0")s
    ...
    for (Volume volume : volumes.getItems()) {
      ...
      System.out.println("==========");
      //System.out.println(volume.getSaleInfo().getListPrice().getAmount());
      // Title.
